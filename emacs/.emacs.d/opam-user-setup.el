...
;; ## added by OPAM user-setup for emacs / tuareg ## 6a984b690304fbac3c56eb5939c169ef ## you can edit, but keep this line
...
(defun opam-tuareg-autoload (fct file doc args)
  (let ((load-path (cons "/home/etienne/.opam/4.08.1/share/emacs/site-lisp" load-path)))
    (load file))
  (apply fct args))
